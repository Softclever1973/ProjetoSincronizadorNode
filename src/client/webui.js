...
const { listarPendentes, resolverConflito, lerTodos, salvarConflito, salvarLoteConflitos, clearConflitos, emitter: conflitosEmitter } = require('./infrastructure/persistence/conflitos');
const { lerTodos: lerErros, limparErros, emitter: errosEmitter } = require('./infrastructure/persistence/erros');
const { emitter: atualizacaoEmitter } = require('./application/updater');
const { aplicarResetLocal, emitter: resetEmitter } = require('./application/resetLocal');
